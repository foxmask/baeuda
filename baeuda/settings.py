...
ANKI_FIELD_COUNT = 2   # number of columns to grab from a joplin table
ANKI_FIELDS = ['한굴', 'Français']  # put the name of the fields you want to use with the "ANKI_MODEL"
